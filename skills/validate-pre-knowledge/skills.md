---
skill_id: "validate-pre-knowledge"
...
- On a `fail` verdict, do NOT just keep probing. Hand off to
  `diagnose-prerequisite-gaps` or a concept refresher. Repeated
...
- **fail** → hand off to `diagnose-prerequisite-gaps` or a concept
...
- `escalate-hint-level-gradually` scaffolds during a specific
